...
class AIClient:
    ...
    - Рекомендации в блоке с исправленной версии отчета вставляй В_ТАКОМ_ФОРМАТЕ, не надо заполнять их выдуманными данными
...

    {
      ...
      Для мест, которые требуют уточнения или корректировки, используй ТАКОЙ_ФОРМАТ без выдуманных данных, чтобы пользователь мог выделить место для вставки двойным нажатием мыши"
    }
    """.strip()
